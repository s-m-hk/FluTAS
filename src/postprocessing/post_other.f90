...
subroutine histograms(ng,dims,n,u,v,w,bin_r, minmax,istep, doDeriv)
...
subroutine energyBalance_mf(ng,dims,n,u,v,w,p,psi,kappa,rho,mu,time,nh_d,nh_vof,halo_vof, dzc,dzf)
  use mod_param, only: dli, sigma, cbcvof, bcvof, is_outflow, dl, rho1, rho2
  implicit none
